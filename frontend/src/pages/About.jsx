    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-16'>
          ...
          <div className='flex flex-col justify-center gap-6 md:w-2/4 text-gray-600'>
              <p>Forever was created from a passion for innovation and a goal to transform online shopping. Our journey started with a simple vision: to offer a platform where customers can easily browse, explore, and buy a variety of products from the comfort of their own homes.</p>
